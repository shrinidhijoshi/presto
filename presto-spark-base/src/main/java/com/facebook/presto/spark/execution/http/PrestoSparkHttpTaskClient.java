...
public class PrestoSparkHttpTaskClient
{
    ...
    {
        Request request = setContentTypeHeaders(false, new Request.Builder())
    ...
    // Bridge interface to replace airlift ResponseHandler
            ...
            implements OkHttpResponseHandler<PagesResponse>
    {
        ...
        public BaseResponse<PagesResponse> handle(Request request, Response response) throws IOException
        {
            try {
                ...
                try (SliceInput input = new InputStreamSliceInput(responseBody.byteStream())) {
                ...
                throw new PageTransportErrorException(
                        e.getRemoteHost(),
                        "Error fetching " + request.url().toString(),
                        e);
            }
        }
