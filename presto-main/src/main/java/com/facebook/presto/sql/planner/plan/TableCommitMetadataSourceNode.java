...
@Immutable
public class TableCommitMetadataSourceNode
        extends InternalPlanNode
{
    ...
    public TableCommitMetadataSourceNode(
    ...
    {
        return visitor.visitTableCommitMetadataSourceNode(this, context);
    }
    ...
    {
        return new TableCommitMetadataSourceNode(getSourceLocation(), getId(), statsEquivalentPlanNode, sourceFragmentIds, outputVariables, ensureSourceOrdering, orderingScheme, exchangeType);
    }
}
